...
def llm_workflow(model_name, user_input):
...
# for i in evaluator_messages:
#     print("=========================evaluator messages=========================")
#     print(i)
#     print('\n----------------------------------------------------------\n')

# for i in coder_messages:
#     print("=========================coder messages=========================")
#     print(i)
#     print('\n----------------------------------------------------------\n')

# display_figures(stdout, current_figures)
